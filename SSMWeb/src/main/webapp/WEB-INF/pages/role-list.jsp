    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/user/userList.do?page=1&&pageSize=4">角色管理</a>
                </li>
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建"
                                            onclick='location.href="${pageContext.request.contextPath}/role/addRole.do"'>
                                        <i
                                ...
                                <c:forEach items="${pageInfo.list}" var="role" varStatus="s">
                                    <tr class="product-strong">
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn bg-olive btn-xs"
                                                    onclick='location.href="${pageContext.request.contextPath}/role/role_show.do?code=${role.code}"'>详情
                                            </button>
                                            <button type="button" class="btn bg-olive btn-xs"
                                                    onclick='location.href="${pageContext.request.contextPath}/role/addRoleAndPermission.do?code=${role.code}"'>添加角色
                                            </button>
                                        </td>
                                    </tr>
