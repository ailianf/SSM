    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/product/productList_page.do">产品管理</a></li>
            ...
            <div class="box-body">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <form action="${pageContext.request.contextPath}/product/updateProduct.do?page=${page}&&pageSize=${pageSize}"
                              method="post">
                            <!--label显示的内容-->
                            <div class="tab-pane active" id="tab-label">
                                <div class="row data-type">
                                    ...
                                    <div class="col-md-4 data text">
                                        <input type="text" disabled class="form-control" name="productNum"
                                               value="${product.productNum}">
                                    </div>

                                    <div class="col-md-2 title">产品名称</div>
                                    <div class="col-md-4 data text">
                                        <input type="text" disabled class="form-control" name="productName"
