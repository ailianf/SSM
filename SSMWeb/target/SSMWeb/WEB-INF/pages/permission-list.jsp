    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/user/userList.do?page=1&&pageSize=4">资源权限管理</a>
                </li>
                    ...
                    <div class="table-box">
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建"
                                            onclick='location.href="${pageContext.request.contextPath}/permission/addPermission.do"'>
                                        <i
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <c:if test="${not empty pageInfo.list}">
                                <c:forEach items="${pageInfo.list}" var="permission" varStatus="s">
                                    <tr class="product-strong">
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn bg-olive btn-xs"
                                                    onclick='location.href="${pageContext.request.contextPath}/permission/user_show.do?code=${userInfo.code}"'>详情
                                            </button>
                                            <button type="button" class="btn bg-olive btn-xs"
                                                    onclick='location.href="${pageContext.request.contextPath}/permission"'>添加角色
                                            </button>
                                        </td>
                                    </tr>
