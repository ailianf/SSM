    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/user/userList.do?page=1&&pageSize=4">用户管理</a>
                </li>
                            ...
                            <c:if test="${not empty pageInfo.list}">
                                <c:forEach items="${pageInfo.list}" var="userInfo" varStatus="s">
                                    <c:if test="${userInfo.status == 1}">
                                        <tr class="product-strong">
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn bg-olive btn-xs"
                                                        onclick='location.href="${pageContext.request.contextPath}/user/user_show.do?code=${userInfo.code}"'>详情
                                                </button>
                                                <button type="button" class="btn bg-olive btn-xs"
                                                        onclick='location.href="${pageContext.request.contextPath}/user/updateUserInfo.do?page=${pageInfo.pageNum}&&pageSize=${pageInfo.pageSize}&&code=${userInfo.code}"'>
                                                    编辑
                                                </button>
                                                <button type="button" class="btn bg-olive btn-xs"
                                                        onclick='location.href="${pageContext.request.contextPath}/user/userAddRole.do?code=${userInfo.code}"'>添加角色
                                                </button>
                                            </td>
                                        </tr>
                                    </c:if>
                                    <c:if test="${userInfo.status == 0}">
                                        <tr class="product-strong">
                                            <td><input name="ids" type="checkbox"></td>
                                            <td style="color: #3DA0DB">${userInfo.code}</td>
                                            <td style="color: #3DA0DB">${userInfo.email}</td>
                                            <td style="color: #3DA0DB">${userInfo.userName}</td>
                                            <td style="color: #3DA0DB">${userInfo.phoneNum}</td>
                                            <td style="color: #3DA0DB">${userInfo.statusStr}</td>
                                            <td>
                                                    <%-- <button type="button" class="btn bg-olive btn-xs"
                                                             onclick='location.href="all-order-manage-edit.html"'>订单
                                                     </button>
                                                ...
                                                <button type="button" class="btn bg-olive btn-xs"
                                                        onclick='location.href="${pageContext.request.contextPath}/user/updateUser.do?page=${pageInfo.pageNum}&&pageSize=${pageInfo.pageSize}&&code=${userInfo.code}"'>
                                                    编辑
                                                </button>
                                                <button type="button" class="btn bg-olive btn-xs"
                                                        onclick='location.href="${pageContext.request.contextPath}/user/userAddRole.do?code=${userInfo.code}?code=${userInfo.code}"'>添加角色
                                                </button>
                                            </td>
                                        </tr>
                                    </c:if>
