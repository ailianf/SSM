                                ...
                                <c:if test="${not empty list}" >
                                    <c:forEach items="${list}" var="order" varStatus="s">
                                        <tr>
                                            ...
                                            <th class="sorting_asc">${order.code}</th>
                                            <th class="sorting">${order.orderNum}</th>
                                            <th class="sorting">${order.product.productName}</th>
                                            <th class="sorting">${order.product.productPrice}</th>
                                            <th class="sorting">${order.orderTimeStr}</th>
                                            <th class="sorting">${order.orderStatusStr}</th>
