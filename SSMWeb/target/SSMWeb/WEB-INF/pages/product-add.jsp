    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/product/productList.do">产品管理</a></li>
                            ...
                            <div class="tab-pane active" id="tab-label">
                                <div class="row data-type">
                                    ...
                                    <div class="col-md-10 data rowHeight2x">
                                        <textarea class="form-control" name="productDesc" rows="3" placeholder="产品描述"></textarea>
                                    </div>
